    ...
    internal sealed class DiagnosticBag : IEnumerable<Diagnostic>
    {
        ...
        internal void ReportRequiredTypeNotFound( string? name , string metadataName )
        {
            var msg = name == null
                ...
                : $"The required type '{name}' ('{metadataName}') cannot be resolved among the given references.";

            this.Report( default , msg );
        }
        ...
        internal void ReportRequiredTypeAmbiguous( string? name , string metadataName , TypeDefinition[] foundTypes )
        {
            ...
            var msg = name == null
                ...
                : $"The required type '{name}' ('{metadataName}') was found in multiple references: {assemblyNameList}.";
        ...
        internal void ReportRequiredMethodNotFound( string typeName , string methodName , string[] parameterTypeNames )
            => this.Report( default , $"The required method '{typeName}.{methodName}({string.Join( ", " , parameterTypeNames )})' cannot be resolved among the given references." );
